...
class ListViewAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        holder.carImage?.setImageDrawable(context.resources.getDrawable(R.drawable.download2, context.theme))
...
//            context.resources.getDrawable(R.drawable.download2, context.theme)
//        )
